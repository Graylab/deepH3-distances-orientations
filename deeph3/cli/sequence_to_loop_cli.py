...
from deeph3.util import pdb2fasta, get_probs_from_model, binned_matrix, binned_dist_mat_to_values, get_dist_bins, get_omega_bins, get_theta_bins, get_phi_bins, get_bin_values, protein_dist_matrix, load_full_seq
    ...
    for job_config in tqdm(job_configs):
        ...
        if native_constraints:
            ...
            with torch.no_grad():
                ...
                pred_dist_mat = binned_dist_mat_to_values(binned_matrix(probs[0], are_logits=False))
